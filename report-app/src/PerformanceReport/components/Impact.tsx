    ...
    <section className="bg-sky-950 rounded-2xl p-8 text-white shadow-xl break-inside-avoid mt-8">
      ...
      <ul className="space-y-4">
        ...
        <li className="flex items-start gap-3 text-lg leading-relaxed">
          ...
          <span className="text-slate-200">
            프론트엔드 관점에서{' '}
            <strong className="text-yellow-400">확장 가능한 UI 구조 및 개발 기준 정리</strong>
          </span>
        </li>
        <li className="flex items-start gap-3 text-lg leading-relaxed">
          <span className="flex items-center justify-center w-6 h-6 rounded-full bg-slate-700 text-slate-300 text-xs font-bold mt-1 shrink-0">
          ...
          <span className="text-slate-200">
            API 연동이 필요한 부분에서{' '}
            <strong className="text-yellow-400">
              비즈니스 로직 및 스키마 선행 설계를 통한 병렬 개발 및 커뮤니케이션 비용 감소
            </strong>
          </span>
        </li>
        <li className="flex items-start gap-3 text-lg leading-relaxed">
          ...
          <span className="text-slate-200">
            ...
            <strong className="text-yellow-400">실제 서비스 연동 단계의 개발 리스크 완화</strong>
          </span>
        </li>
        <li className="flex items-start gap-3 text-lg leading-relaxed">
          <span className="flex items-center justify-center w-6 h-6 rounded-full bg-slate-700 text-slate-300 text-xs font-bold mt-1 shrink-0">
          ...
          <span className="text-slate-200">
            ...
            <strong className="text-yellow-400">조직 단위 개발 효율 및 지속 가능성 확보</strong>
          </span>
        </li>
      </ul>
    </section>
