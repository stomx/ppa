    ...
    <section className="space-y-4">
            ...
            <table className="w-full text-sm text-left">
              <tbody className="divide-y divide-slate-100">
                <tr className="group hover:bg-slate-50">
                  <th className="py-4 pr-4 font-bold text-slate-600 w-24 sm:w-32 align-top">
                    역할
                  </th>
                ...
                <tr className="group hover:bg-slate-50">
                  ...
                  <td className="py-4 text-slate-800">
                    ...
                    <div className="mt-1 text-slate-600 bg-slate-100 bg-opacity-50 p-2 rounded">
                      페이지 구현 - 랜딩, 에이전트 목록, 에이전트 상세, 요금-구독, 요금-크레딧,
                      오버뷰, 개인정보처리방침, 이용약관
                    </div>
                  </td>
                </tr>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden break-inside-avoid">
        <div className="p-6 border-b border-slate-100 bg-slate-50">
          ...
          <p className="text-slate-600">
            <strong className="text-slate-900">
              API 연동이 필요한 영역에서 스키마 선행 설계, 비즈니스 로직 작성·문서화하고, 백엔드
              개발자와 병렬 작업을 수행함으로써 커뮤니케이션 비용 절감 및 개발 효율성 향상
            </strong>
          </p>
        </div>
        <div className="p-6">
            ...
            <table className="w-full text-sm text-left">
              <tbody className="divide-y divide-slate-100">
                ...
                <tr className="group hover:bg-slate-50">
                  ...
                  <td className="py-4 text-slate-800">스키마 기반 비즈니스 로직 및 화면 구현</td>
                </tr>
                <tr className="group hover:bg-slate-50">
                ...
                <tr className="group hover:bg-slate-50">
                  ...
                  <td className="py-4 text-slate-800">Fake API 기반 기능 및 UI 흐름 검증</td>
                </tr>
                <tr className="group hover:bg-slate-50">
                  <th className="py-4 pr-4 font-bold text-slate-600 align-top">정리</th>
                  <td className="py-4 text-slate-800">실제 API·DB 연동 시 변경 지점 정리</td>
                </tr>
                <tr className="group hover:bg-slate-50">
