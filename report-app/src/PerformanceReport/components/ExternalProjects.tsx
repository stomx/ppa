        ...
        <section className="space-y-4">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex flex-col">
                ...
                <p className="text-slate-600 mb-4">
                    <strong className="text-slate-900">외부 고객사 대상 SI 업무를 지원하며, 납기 준수와 서비스 안정성을 확보하는 역할 수행</strong>.
                </p>
                <div className="space-y-4">
                    <div className="p-4 bg-slate-50 rounded-lg">
                        <strong className="block text-slate-800 mb-1">한국열연 브로셔 프로젝트 SI 업무 지원</strong>
            ...
            {/* 3-2 */}
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex flex-col">
                <h3 className="text-lg font-bold text-slate-800 mb-2">3-2. 서비스 안정성 관련 대응 (w/로건)</h3>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex flex-col">
                ...
                <p className="text-slate-600 mb-4">
                    <strong className="text-slate-900">단발성 SI 작업에 그치지 않고, 반복 업무를 줄이기 위한 생산성 도구와 문서를 조직 자산으로 정리</strong>함.
                </p>
                <ul className="list-disc list-inside text-sm text-slate-700 ml-2 space-y-2">
                    <li>한국열연 브로셔 웹앱 포팅 과정에서 <strong className="text-teal-700">WebApp Generator</strong> 개발</li>
